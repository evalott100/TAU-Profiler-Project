...
dir=/dls/science/users/twj43146/programming/heat/2D

export TAU_EBS_PERIOD=2000
export TAU_METRICS=TIME:PAPI_VEC_SP:PAPI_VEC_DP
export TAU_COMM_MATRIX=1
export TAU_CALLPATH=1
export TAU_CALLPATH_DEPTH=1
export TAU_SAMPLING=1

mpirun -np 6  tau_exec $dir/heat 1000 1000
